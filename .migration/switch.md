...
- Leftover scan is clean: `grep -n "radix-ui\|@radix-ui" src/components/ui/switch.tsx src/components/shared/contact-form.tsx` returned no matches.
...
- Temporarily render the switch disabled and confirm it cannot be toggled and shows its disabled cursor and opacity.
